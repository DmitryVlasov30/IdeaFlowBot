...
class Channel(EditorialBase, BaseIdMixin, TimestampMixin):
    ...
    min_gap_minutes: Mapped[int] = mapped_column(Integer, default=180, nullable=False)
    ...
    max_paste_per_day: Mapped[int] = mapped_column(Integer, default=2, nullable=False)
